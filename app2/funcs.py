...
titleLbl = tk.Label(text = 'Global Subtitles', font = ('Times New Roman', '48'), master = titleFrame)
titleFrame.grid(row = 0, column = 0)
titleLbl.grid(row = 0, column = 0)

buttonFrame = tk.Frame(master = startWindow)
buttonFrame.columnconfigure(2)
startBtn = tk.Button(master = buttonFrame, text = 'Start', font = ('Times New Roman', '30'), command = loop)
