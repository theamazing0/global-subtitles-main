...
def readFileUpdateSubtitle():
    ...
    subtitleLbl["text"] = settings.subtitleVar
...
def gui():
    ...
    startBtn.grid(row = 1, column= 0, padx = 1, sticky=E)
    settingsBtn = tk.Button(master=startWindow, text= "⚙", command=settingsFunc)
    settingsBtn.grid(row=1,column= 1, padx = 1, sticky=SE)
